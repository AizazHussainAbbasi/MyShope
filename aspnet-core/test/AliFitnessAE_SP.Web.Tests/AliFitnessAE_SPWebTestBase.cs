...
{
    public abstract class AliFitnessAE_SPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AliFitnessAE_SPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AliFitnessAE_SPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AliFitnessAE_SPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AliFitnessAE_SPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AliFitnessAE_SPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AliFitnessAE_SPDbContext, Task<T>> func)
        {
            T result;
