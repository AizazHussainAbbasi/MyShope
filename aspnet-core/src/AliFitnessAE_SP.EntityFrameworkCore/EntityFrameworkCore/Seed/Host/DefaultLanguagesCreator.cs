...
namespace AliFitnessAE_SP.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AliFitnessAE_SPConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AliFitnessAE_SPDbContext context)
        {
            _context = context;
        }
